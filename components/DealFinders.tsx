  ...
  const teamMembers = [
    {
      ...
      description: 'Stefan liebt es, Deals zu finden, bei denen andere zweimal hinschauen müssen. Er kennt die besten Rabatte und Preistrends und bleibt immer einen Schritt voraus, um Ihnen die wertvollsten Angebote zu bringen.',
      image: 'https://images.unsplash.com/photo-1539571696357-5a69c17a67c6?w=400&h=400&fit=crop&crop=face&q=80'
    },
    {
      name: 'Sarah',
      title: 'Die Alltagsstrategin',
      description: 'Sarah optimiert den Alltag für Familien mit cleveren Deals – von Haushaltsgeräten bis hin zu Abonnements, die wirklich lohnenswert sind. Sie weiß, was Familien wirklich brauchen.',
    ...
    },
    {
      ...
      description: 'Thomas verbindet technisches Know-how mit einer Leidenschaft für die besten Tech-Deals. Von Gaming-Ausrüstung bis hin zu Smart-Home-Lösungen sorgt er dafür, dass jede Empfehlung Ihr Geld wert ist.',
    ...
    <section className="container mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16 lg:py-20">
      <div className="text-center mb-12">
        ...
        <p className="text-gray-600 text-base sm:text-lg lg:text-xl max-w-2xl mx-auto">
          Das Team hinter preis-buddy.de – Experten, die täglich die besten Deals für Sie finden.
        </p>
      </div>

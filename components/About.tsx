    ...
    <section className="bg-gradient-to-br from-purple-600 via-pink-600 to-purple-700 py-16 md:py-20 lg:py-24">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center max-w-4xl">
        <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-6">
          Willkommen bei preis-buddy.de – der Plattform für smarte Technikliebhaber.
        </h2>
        ...
        <div className="text-white text-base sm:text-lg leading-relaxed space-y-6 mb-8">
          ...
          <p>
            preis-buddy.de richtet sich an alle, die gute Technik genauso schätzen wie wir – egal ob fürs Homeoffice, Entertainment, Gaming oder einfach für den Alltag.
          </p>
